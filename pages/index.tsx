...
export default function Index() {
  return (
    <>
      ...
      <section id="lm">
        <div className="relative flex flex-col-reverse justify-center w-2/3 mx-auto h-max sm:flex-row sm:h-screen sm:w-full">
        ...
        <div className="relative flex flex-col justify-center w-2/3 mx-auto h-max sm:h-screen sm:flex-row sm:w-full">
          <div className="grid w-full sm:w-1/2 place-items-center">
            <div className="w-full h-3/5">
