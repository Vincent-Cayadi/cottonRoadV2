      ...
      >
        ...
        <div className="grid w-full sm:w-1/2 place-items-center">
          <div className="w-full h-4/5">
            ...
            <div className="absolute right-0 invisible w-2/4 bg-purple-200 rounded-l-full bottom-60 sm:visible -z-10 h-2/6"></div>
          </div>
        </div>
      </section>
      <section className="relative flex flex-col justify-center w-2/3 mx-auto h-max sm:h-screen sm:flex-row sm:w-full">
        <div className="grid w-full sm:w-1/2 place-items-center">
          <div className="w-full h-4/5">
            ...
            <div className="absolute left-0 invisible w-2/4 bg-purple-200 rounded-r-full bottom-60 sm:visible -z-10 h-2/6"></div>
          </div>
        </div>
